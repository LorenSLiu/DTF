...
public class TeamPage extends VerticalLayout implements HasUrlParameter<String> {
    ...
    Connection conn = DriverManager.getConnection("jdbc:mysql://50.87.253.209:3306/restockt_Scouting?useSSL=false&allowPublicKeyRetrieval=true", "restockt_2637", "K$JQE+4L#T5?");
    ...
    private void initTeamPage() throws SQLException, ClassNotFoundException {
        ...
        charts.forEach(component -> add(component));
